...
app.post("/uploadprofile", isLoggedIn,uploadprofile.single("profile"), async function(req, res){
...
app.post("/uploadpost", isLoggedIn,uploadpost.single("post"), async function(req, res){
...
app.get("/recomment", isLoggedIn,async(req, res) => {
...
app.post("/recomment", isLoggedIn,async(req, res) => {
...
app.get("/private", isLoggedIn, async(req, res) => {
...
app.get("/comment", isLoggedIn, async(req, res) => {
...
app.get("/block", isLoggedIn,async(req, res) => {
...
app.get("/unblock", isLoggedIn,async(req, res) => {
